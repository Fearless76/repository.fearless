        ...
        def movieDirectory(self, items):
                ...
                for i in items:
                        try:
                                ...
                                if "tt" in imdb                     : sysmetalliq = "plugin://plugin.video.metalliq/movies/add_to_library_parsed/imdb/%s/direct.untouchables.q" % imdb
                                elif not tmdb == "0" or tmdb == None: sysmetalliq = "plugin://plugin.video.metalliq/movies/add_to_library_parsed/tmdb/%s/direct.untouchables.q" % tmdb
                                else                                : sysmetalliq = "0"
