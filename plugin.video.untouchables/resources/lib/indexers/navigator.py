...
class navigator:
        def root(self):
                ...
                self.addDirectoryItem('My Untouchables',       'lists_navigator',      'mymovies.png',      'DefaultRecentlyAddedMovies.png')
...
#		self.addDirectoryItem('Trending',          'movies&url=trending',   'trending.png',      'DefaultRecentlyAddedMovies.png')
        ...
        def tools(self):
                ...
                self.addDirectoryItem('[B]Untouchables[/B]: Views', 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]Untouchables[/B]: Clear Providers', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]Untouchables[/B]: Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem('[B]Untouchables[/B]: Clear Progress Database', 'clearProgress', 'tools.png', 'DefaultAddonProgram.png')
                self.endDirectory()
