...
addon_id = 'plugin.video.untouchables'
	...
	if d:
		...
		if (kb.isConfirmed()):
			...
			if pw =="":
				...
				xbmcaddon.Addon('plugin.video.untouchables').setSetting('xxxpass',pw)
				xbmcaddon.Addon('plugin.video.untouchables').setSetting('enablexxxpass','true')
