...
class tvshows:
    def __init__(self):
        ...
        if self.tmdb_key == '' or self.tmdb_key == None: self.tmdb_key = base64.b64decode('M2Q3M2NhM2MyNWQ2ZGFkNTZjYWNiYTVlZTEyZDQzMmM=')
        self.tmdb_lang            = 'en'
        self.datetime             = (datetime.datetime.utcnow() - datetime.timedelta(hours = 5))
    ...
    def tvshowDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                if not tvdb == "0" or tvdb == None: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.untouchables.q" % tvdb
                elif "tt" in imdb: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.untouchables.q" % imdb
                else: sysmetalliq = "0"
