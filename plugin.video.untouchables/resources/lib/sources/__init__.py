...
class sources:
    ...
    def getSources(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, presetDict=[], timeout=30):
        ...
        progressDialog.update(0, 'Probing Untouchables...')
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.untouchables.container.items'

        self.metaProperty = 'plugin.video.untouchables.container.meta'
